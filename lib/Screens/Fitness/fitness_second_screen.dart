...
class FitnessSecondScreen extends StatefulWidget {
  @override
  _FitnessSecondScreenState createState() => _FitnessSecondScreenState();
}

class _FitnessSecondScreenState extends State<FitnessSecondScreen> {
  @override
